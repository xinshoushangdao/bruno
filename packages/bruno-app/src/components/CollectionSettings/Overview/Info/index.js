      ...
      <div className="rounded-lg py-6">
        <div className="grid gap-5">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <div className="font-medium">{t('COLLECTION_SETTINGS.LOCATION')}</div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <div className="font-medium">{t('COLLECTION_SETTINGS.ENVIRONMENTS')}</div>
              <div className="mt-1 flex flex-col gap-1">
                ...
                >
                  {t('COLLECTION_SETTINGS.COLLECTION_ENVIRONMENT', { count: collectionEnvironmentCount })}
                </button>
                <button
                  type="button"
                  className="text-link cursor-pointer hover:underline text-left bg-transparent"
                ...
                >
                  {t('COLLECTION_SETTINGS.GLOBAL_ENVIRONMENT', { count: globalEnvironmentCount })}
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <div className="font-medium">{t('COLLECTION_SETTINGS.REQUESTS')}</div>
              <div className="mt-1 text-muted">
                {
                  isCollectionLoading ? t('COLLECTION_SETTINGS.REQUESTS_LOADING', { loaded: totalItems - itemsLoadingCount, total: totalItems }) : t('COLLECTION_SETTINGS.REQUESTS_IN_COLLECTION', { count: totalRequestsInCollection })
                }
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start group cursor-pointer" onClick={handleToggleShowShareCollectionModal(true)}>
            ...
            <div className="ml-4 h-full flex flex-col justify-start">
              <div className="font-medium h-fit my-auto">{t('COLLECTION_SETTINGS.SHARE')}</div>
              <div className="group-hover:underline text-link">
                {t('COLLECTION_SETTINGS.SHARE_COLLECTION')}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start group cursor-pointer" onClick={() => setShowGenerateDocumentationModal(true)}>
            ...
            <div className="ml-4 h-full flex flex-col justify-start">
              <div className="font-medium h-fit my-auto">{t('COLLECTION_SETTINGS.DOCUMENTATION')}</div>
              <div className="group-hover:underline text-link">
                {t('COLLECTION_SETTINGS.GENERATE_DOCS')}
              </div>
            </div>
          </div>
